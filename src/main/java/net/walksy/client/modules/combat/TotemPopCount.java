...
public class TotemPopCount extends Module {
    ...
    private static class PlayerEntry {
        ...
        public void valid() {
            this.lastValid = WalksyClient.getCurrentTime();
        }
    }
    ...
    public void fireEvent(Event event) {
        switch (event.getClass().getSimpleName()) {
            ...
            case "ClientTickEvent": {
                for (PlayerEntity player : WalksyClient.getClient().world.getPlayers()) {
                    UUID uuid = player.getUuid();
                ...
                for (UUID uuid : this.entries.keySet()) {
                    ...
                    if (WalksyClient.getCurrentTime() - lastValid >= duration) {
            ...
            case "OnEntityStatusEvent": {
                ...
                Entity entity = e.packet.getEntity(WalksyClient.me().world);
