...
public abstract class Module extends Settings implements EventListener, Flatternable {
    ...
    protected final static EventManager eventManager = WalksyClient.getInstance().getEventManager();
    ...
    public void onEnabled() { 
        WalksyClient.displayChatMessage(
    ...
    */
     ...
     */
    private EventEmitter emitter = WalksyClient.getInstance().emitter;
    ...
    public void lift(HashMap<String, String> data) {
        ...
        for (String name : data.keySet()) {
            ...
            if (setting == null) {
                WalksyClient.log(String.format("Unknown setting '%s' in mod '%s.'", name, this.getName()));
                continue;
            }
            ...
            if (setting.value instanceof Mode) {
                ...
                if (!mode.setState(val)) {
                    WalksyClient.log(String.format("Invalid state '%s' for setting '%s' in mod '%s.'", val, name, this.getName()));
                    continue;
                }
