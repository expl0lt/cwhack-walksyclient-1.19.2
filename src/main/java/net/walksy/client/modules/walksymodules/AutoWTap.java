...
public class AutoWTap extends Module  {
    ...
    public void fireEvent(Event event) {
        switch (event.getClass().getSimpleName()) {
            case "ClientTickEvent": {
                if (WalksyClient.getClient().options.forwardKey.isPressed()) {
                ...
                if (WalksyClient.getClient().options.forwardKey.isPressed()) {
                    if (WalksyClient.getClient().options.attackKey.isPressed()) {
                        setPressed(WalksyClient.getClient().options.backKey, true);
                    }
                }
            }
        }
    ...
    private void unpress() {
        setPressed(WalksyClient.getClient().options.backKey, false);
    }
