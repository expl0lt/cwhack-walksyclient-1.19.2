...
public class ShulkerPeak extends Module {
    private static final Identifier BACKGROUND_TEXTURE = new Identifier("walksy-client", "textures/gui/misc/shulker_tooltip_header.png");
    ...
    private void renderBackground(MatrixStack matrices, ItemStack stack, int x, int y) {
        ...
        TextRenderer r = WalksyClient.getClient().textRenderer;
    ...
    private void renderShulkerDisplay(MatrixStack mStack, ItemStack stack, int x, int y) {
        ...
        ItemRenderer ir = WalksyClient.getClient().getItemRenderer();
        TextRenderer r = WalksyClient.getClient().textRenderer;
    ...
    public void fireEvent(Event event) {
        switch (event.getClass().getSimpleName()) {
            ...
            case "InGameHudRenderEvent": {
                ...
                // Get the active item.
                ItemStack stack = WalksyClient.me().getMainHandStack();
                ...
                int x = WalksyClient.getClient().getWindow().getScaledWidth()/2 - BACKGROUND_WIDTH/2;
                int y = (int)(32/ WalksyClient.getClient().getWindow().getScaleFactor());
