...
import net.walksy.client.utils.Render2DUtils;
...
public class TargetCircle {
    ...
    public double getRadius() {
        return fov * WalksyClient.getClient().getWindow().getScaledWidth() / WalksyClient.getClient().options.getFov().getValue();
    }
    ...
    public Iterable<Entity> getEntities() {
        ...
        for (Entity entity : WalksyClient.getClient().world.getEntities()) {
            if (entity == WalksyClient.me()) continue;
