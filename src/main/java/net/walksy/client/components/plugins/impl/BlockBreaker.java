...
public class BlockBreaker implements ModulePlugin {
    ...
    private void sendStartBreakPacket(BlockPos pos) {
        ...
        WalksyClient.me().networkHandler.sendPacket(new PlayerActionC2SPacket(PlayerActionC2SPacket.Action.START_DESTROY_BLOCK, pos, Direction.UP));
        started.add(pos);
    }
    ...
    private void sendBreakPacket(BlockPos pos) {
        WalksyClient.me().networkHandler.sendPacket(new PlayerActionC2SPacket(PlayerActionC2SPacket.Action.STOP_DESTROY_BLOCK, pos, Direction.UP));
    }
    ...
    private void breakNext() {
        ...
        if (this.forceBreak) {
            ...
            WalksyClient.getClient().interactionManager.updateBlockBreakingProgress(pos, Direction.UP);
        }
    }
