package net.walksy.client.commands.settings;
...
import net.walksy.client.commands.structures.CommandNode;
...
public class SettingsCommand extends CommandNode {
    ...
    private static abstract class GenericSettingCommand extends Command {
        ...
        public void showValue() {
            WalksyClient.displayChatMessage(String.format("%sSetting Value: %s", ChatUtils.WHITE, setting.value.toString()));
        }
    ...
    private static abstract class NumericalSettingCommand extends GenericSettingCommand {
        ...
        public void showNaNMessage() {
            WalksyClient.displayChatMessage(String.format("%sInvalid Value: received NaN as a parameter", ChatUtils.RED));
        }
    ...
    public Boolean trigger(String[] args) {
        if (args.length == 0) {
            WalksyClient.displayChatMessage("Current Settings:");
