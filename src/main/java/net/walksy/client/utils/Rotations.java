...
import static net.walksy.client.utils.WorldUtils.mc;
...
public class Rotations {
    ...
    public static double getYaw(Vec3d pos) {
        return mc.player.getYaw() + MathHelper.wrapDegrees((float) Math.toDegrees(Math.atan2(pos.getZ() - WalksyClient.getClient().player.getZ(), pos.getX() - mc.player.getX())) - 90f - mc.player.getYaw());
    }

    public static double getPitch(Vec3d pos) {
        double diffX = pos.getX() - WalksyClient.getClient().player.getX();
        double diffY = pos.getY() - (WalksyClient.getClient().player.getY() + WalksyClient.getClient().player.getEyeHeight(WalksyClient.getClient().player.getPose()));
        double diffZ = pos.getZ() - WalksyClient.getClient().player.getZ();

        double diffXZ = Math.sqrt(diffX * diffX + diffZ * diffZ);

        return WalksyClient.getClient().player.getPitch() + MathHelper.wrapDegrees((float) -Math.toDegrees(Math.atan2(diffY, diffXZ)) - WalksyClient.getClient().player.getPitch());
    }
    ...
    public static double getPitch(Entity entity, Target target) {
        ...
        double diffX = entity.getX() - WalksyClient.getClient().player.getX();
        double diffY = y - (WalksyClient.getClient().player.getY() + WalksyClient.getClient().player.getEyeHeight(WalksyClient.getClient().player.getPose()));
        double diffZ = entity.getZ() - WalksyClient.getClient().player.getZ();
    ...
    public static double getYaw(BlockPos pos) {
        return WalksyClient.getClient().player.getYaw() + MathHelper.wrapDegrees((float) Math.toDegrees(Math.atan2(pos.getZ() + 0.5 - WalksyClient.getClient().player.getZ(), pos.getX() + 0.5 - WalksyClient.getClient().player.getX())) - 90f - WalksyClient.getClient().player.getYaw());
    }

    public static double getPitch(BlockPos pos) {
        double diffX = pos.getX() + 0.5 - WalksyClient.getClient().player.getX();
        double diffY = pos.getY() + 0.5 - (WalksyClient.getClient().player.getY() + WalksyClient.getClient().player.getEyeHeight(WalksyClient.getClient().player.getPose()));
        double diffZ = pos.getZ() + 0.5 - WalksyClient.getClient().player.getZ();
    ...
    private static class Rotation {
        ...
        public void sendPacket() {
            WalksyClient.getClient().getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.LookAndOnGround((float) yaw, (float) pitch, WalksyClient.getClient().player.isOnGround()));
            runCallback();
        }
