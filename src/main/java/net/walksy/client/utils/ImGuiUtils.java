...
public class ImGuiUtils {
     ...
     */
    private static final String FONT_PATH = "assets/walksy-client/font/walksy.ttf";
    ...
    public static void refreshStyle() {
        ...
        // Backgrounds
        style.setColor(ImGuiCol.WindowBg, 0.10f, 0.10f, 0.10f, 0.25f);
        style.setColor(ImGuiCol.ChildBg, 0.10f, 0.10f, 0.10f, 0.25f);
        style.setColor(ImGuiCol.PopupBg, 0.10f, 0.10f, 0.10f, 0.25f);
        style.setColor(ImGuiCol.Border, 0.10f, 0.10f, 0.10f, 0.25f);

        // Window Title
        float k = 0.50f;
        style.setColor(ImGuiCol.TitleBg, 0.36f, 0.00f, 0.90f, 1f);
        style.setColor(ImGuiCol.TitleBgActive, 0.37f, 0.00f, 0.91f, 1f);
        style.setColor(ImGuiCol.TitleBgCollapsed, 0.36f, 0.00f, 0.90f, 1f);



        // Scrollbar
        style.setColor(ImGuiCol.ScrollbarBg, 0.10f, 0.10f, 0.10f, 0.94f);
        style.setColor(ImGuiCol.ScrollbarGrab, 0.54f, 0.78f, 1.00f, 1.00f);
        ...
        style.setColor(ImGuiCol.BorderShadow, 0.44f, 0.00f, 0.94f, 1.00f);
        ...
        style.setColor(ImGuiCol.CheckMark, 0.4f, 0.0f, 0.4f, 1.00f);
        
        // Slider
        style.setColor(ImGuiCol.SliderGrab, 0.4f, 0.0f, 0.4f, 1.00f);
        style.setColor(ImGuiCol.SliderGrabActive, 0.4f, 0.0f, 0.4f, 1.00f);


        // Button
        style.setColor(ImGuiCol.Button, 0.00f, 0.00f, 0.00f, 0.30f);
        style.setColor(ImGuiCol.ButtonHovered, 0.00f, 0.00f, 0.00f, 0.35f);
        style.setColor(ImGuiCol.ButtonActive, 0.10f, 0.10f, 0.10f, 0.30f);
        
        // Header
        k = 0.1f;
        style.setColor(ImGuiCol.Header, 0.36f, 0.00f, 0.90f, 1f);
        style.setColor(ImGuiCol.HeaderHovered, 0.37f, 0.00f, 0.91f, 1f);
        style.setColor(ImGuiCol.HeaderActive, 0.36f, 0.00f, 0.90f, 1f);
    ...
    public static void init() {
        ...
        long handle = WalksyClient.getClient().getWindow().getHandle();
