...
import net.walksy.client.utils.DrawMode;
...
public class Mesh {
    ...
    public void begin() {
        ...
        building = true;
        rendering3D = WorldUtils.rendering3D;

        if (rendering3D) {
            Vec3d camera = WalksyClient.getClient().gameRenderer.getCamera().getPos();
    ...
    public void beginRender(MatrixStack matrices) {
        ...
        if (rendering3D) {
            ...
            Vec3d cameraPos = WalksyClient.getClient().gameRenderer.getCamera().getPos();
