...
import net.walksy.client.interfaces.mixin.ICapabilityTracker;
import net.walksy.client.misc.PreInit;
import net.walksy.client.mixin.render.BufferRendererAccessor;
...
public class GL {
    ...
    public static void bindTexture(Identifier id) {
        ...
        WalksyClient.getClient().getTextureManager().bindTexture(id);
    }
